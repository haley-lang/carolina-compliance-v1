...
def collect_reminder_reasons(policies: List[Dict[str, Any]]) -> Dict[str, List[str]]:
    reminder_reasons = {}
    ...
    for policy in policies:
        ...
        if vendor_id and expiration_status in ['Expired', 'Expiring in 30 Days']:
...
def choose_most_important_status(reasons: List[str]) -> str:
    priority = ['Expired', 'Expiring in 30 Days']
...
def run() -> None:
    ...
    reminder_reasons = collect_reminder_reasons(policies)
